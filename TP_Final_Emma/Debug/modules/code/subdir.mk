...
modules/code/%.o modules/code/%.su: ../modules/code/%.cpp modules/code/subdir.mk
...
clean: clean-modules-2f-code

clean-modules-2f-code:
	-$(RM) ./modules/code/code.d ./modules/code/code.o ./modules/code/code.su

.PHONY: clean-modules-2f-code
