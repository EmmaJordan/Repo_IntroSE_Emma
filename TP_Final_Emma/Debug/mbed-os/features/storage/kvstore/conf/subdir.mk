...
CPP_DEPS += \
./mbed-os/features/storage/kvstore/conf/kv_config.d 


# Each subdirectory must supply rules for building sources it contributes
mbed-os/features/storage/kvstore/conf/%.o mbed-os/features/storage/kvstore/conf/%.su: ../mbed-os/features/storage/kvstore/conf/%.cpp mbed-os/features/storage/kvstore/conf/subdir.mk
...
clean: clean-mbed-2d-os-2f-features-2f-storage-2f-kvstore-2f-conf

clean-mbed-2d-os-2f-features-2f-storage-2f-kvstore-2f-conf:
	-$(RM) ./mbed-os/features/storage/kvstore/conf/kv_config.d ./mbed-os/features/storage/kvstore/conf/kv_config.o ./mbed-os/features/storage/kvstore/conf/kv_config.su

.PHONY: clean-mbed-2d-os-2f-features-2f-storage-2f-kvstore-2f-conf
