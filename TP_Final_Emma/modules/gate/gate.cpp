...
InterruptIn gateOpenLimitSwitch(D7);
InterruptIn gateCloseLimitSwitch(D6);
...
void gateInit()
{
    gateOpenLimitSwitch.mode(PullDown);
    gateCloseLimitSwitch.mode(PullDown);

    gateOpenLimitSwitch.rise(&gateOpenLimitSwitchCallback);
    gateCloseLimitSwitch.rise(&gateCloseLimitSwitchCallback);
